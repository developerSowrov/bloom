...
export default function MobileNavMenu() {
   ...
   return (
      // background 
      <div data-mobile-menu="true" onClick={onBackgroundClick} className={`md:hidden fixed top-0 left-0 z-[999] h-full w-full backdrop-blur-xs shadow-lg bg-black/5 transition-opacity duration-300 ${isClose ? "opacity-0 pointer-events-none delay-300" : "opacity-100 delay-0"} `}>
         {/* menu */}
