...
import { signIn, signInWithDiscord, signInWithFacebook, signInWithFigma, signInWithGithub, signInWithGoogle, signInWithLinkedIn } from "./lib/auth";
      ...
      <div className="w-full max-w-md bg-white rounded-[1.25rem] p-8 md:p-10 shadow-sm">
        ...
        <form onSubmit={handleSubmit} className="flex flex-col gap-5">
          ...
          <div className="flex items-center justify-between text-sm">
            ...
            <Link href="/forget-password" className="text-black hover:underline font-medium">
              Forgot Password?
            </Link>
          </div>
